...
const apiURL =
  "//api.openweathermap.org/data/2.5/weather?id=5585010&appid=d2fdc86a9958706a70d9f603bde9f1c3&units=imperial";
...
const apiURL2 =
  "//api.openweathermap.org/data/2.5/forecast?id=5585010&appid=d2fdc86a9958706a70d9f603bde9f1c3&units=imperial";
fetch(apiURL2)
  .then((response) => response.json())
  .then((weatherInfo) => {
    console.log(weatherInfo);
